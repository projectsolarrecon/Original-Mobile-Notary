      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <div>
                <div className="font-display text-cream font-semibold text-sm leading-tight">
                  Original Mobile Notary
                </div>
                <div className="font-body text-terra-light text-[10px] tracking-[0.18em] uppercase">
                  of Nashville
                </div>
              </div>
            </div>
            <p className="font-body text-sage-light text-sm leading-relaxed">
              Your friendly, professional mobile notary serving Nashville and surrounding communities. We come to you — wherever you are.
            </p>
            <div className="flex items-center gap-1.5 mt-4">
              <TinyLeaf color="#7A9E8E" className="w-3 h-4" />
              <span className="font-body text-sage text-xs italic">Brigitte — Nashville, TN</span>
            </div>
          </div>

          {/* Quick Links */}
          <div>
            <h3 className="font-display text-terra-light text-sm font-semibold tracking-wide mb-4">
              Quick Links
            </h3>
            <ul className="space-y-2.5">
              {[
                ...
                <li key={link.path}>
                  <Link
                    to={link.path}
                    className="font-body text-sage-light hover:text-cream text-sm transition-colors flex items-center gap-1.5 group"
                  >
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-start gap-2.5">
                ...
                <span className="font-body text-sage-light">Nashville, Tennessee</span>
              </li>
            </ul>
            ...
            <div className="mt-5 pt-4 border-t border-sage-mid/30">
              ...
              <div className="flex flex-wrap gap-2">
                {["Cash", "Zelle", "Venmo", "Card"].map((method) => (
                  <span
                    key={method}
                    className="px-2.5 py-1 bg-sage-mid/20 border border-sage-mid/30 rounded-full text-xs font-body text-sage-light"
                  >
                    {method}
                  </span>
                ))}
        ...
        <div className="mt-10 pt-6 border-t border-sage-mid/20 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="font-body text-sage text-xs">
            © {new Date().getFullYear()} Original Mobile Notary of Nashville. All rights reserved.
          </p>
