    ...
    <div className="overflow-x-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            >
              ...
              <div className="space-y-4 font-body text-stone leading-relaxed">
                ...
                <p>
                  As an NNA-certified notary, Brigitte brings careful attention, clear communication, and a friendly, patient approach to every appointment. She travels throughout Greater Nashville and Middle Tennessee, meeting clients wherever it is most convenient—including their homes, offices, hospitals, care facilities, libraries, and favorite coffee shops.
                </p>
                <p>
      ...
      <section className="py-20 bg-parchment relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.p initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="font-body text-stone text-center max-w-md mx-auto mb-4">
